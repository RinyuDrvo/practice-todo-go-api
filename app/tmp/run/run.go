...
import (
	...
	_ "practice-todo-go-api/app"
	controllers1 "practice-todo-go-api/app/controllers"
	tests "practice-todo-go-api/tests"
...
func Register() {
	...
	revel.RegisterController((*controllers1.TodoController)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Create",
				Args: []*revel.MethodArg{ 
